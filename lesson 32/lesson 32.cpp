...
public:
    ...
    bool Init()
    {
        ...
        if (!m_pMesh1->LoadMesh("C:/Users/sofya/source/repos/lr5 IikG/lesson 32/Content/phoenix_ugv.md2")) {
            return false;
        }

        m_pMesh2 = new Mesh();

        if (!m_pMesh2->LoadMesh("C:/Users/sofya/source/repos/lr5 IikG/lesson 32/Content/jeep.obj")) {
            return false;
        }

        m_pMesh3 = new Mesh();

        if (!m_pMesh3->LoadMesh("C:/Users/sofya/source/repos/lr5 IikG/lesson 32/Content/hheli.obj")) {
            return false;
        }
